    ...
    return Scaffold(
      body: BlocConsumer<AppMainCubit,AppMainStates>(
          ...
          builder: (context,state){
            ...
            List<OrderModel> tripsList = appMainCubitAccess.ordersList.where((element) => element.orderType == "trip").toList();
            return tripsList.length == 0 ? Center(
                      ...
                      children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text("${tripsList[index].orderType}"),
                              )
                            ],
                          ),
                        ),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              SizedBox(
                                width: 40,
                                height: 40,
                                child: Image.file(tripsList[index].orderImage!,fit: BoxFit.fill,),
                              )
                            ],
                          ),
                        ),
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text("From Address"),
                              Text("${tripsList[index].fromAddress!}",style: TextStyle(color: Colors.grey),),
                              SizedBox(height: 10,),
                              Text("To Address"),
                              Text("${tripsList[index].toAddress!}",style: TextStyle(color: Colors.grey),),
                              Divider(),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  tripsList[index].orderType == "shipment" ?
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text("Reward Amount"),
                                      Text("${tripsList[index].rewardAmount!}",style: TextStyle(color: Colors.grey),),
                                    ],
                                  ) :
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      ...
                                      Text("${tripsList[index].availableWeight!}",style: TextStyle(color: Colors.grey),),
                                    ],
                                  ),
                                  ElevatedButton(
                                      onPressed: (){
